@extends('layouts.app')
@section('content')
    <div class="container mx-auto pc-4">
        <div class="game-detaisl border-b border-gray-800 pb-12 flex flex-col lg:flex-row">
            <div class="flex-none">
                <img src="{{ $game['coverImageUrl'] }}" alt="game cover" class="hover:opacity-75 transition ease-in-out duration-150">
            </div>
            <div class="lg:ml-12 lg:mr-64">
                <h2 class="font-semitbold text-4xl leading-tight mt-1">{{ $game['name'] }}</h2>
...
{{--                     <a href="{{ $game['trailer'] }}" class="inline-flex bg-blue-500 text-white font-semibold px-4 py-4 hover:bg-blue-600 rounded transition ease-in-out duration-150">
        ...
        >
            <h2 class="text-blue-500 tracking-wide font-semibold">Images</h2>
            <div class="grid grisl-cols-1  md:grid-cols-2 lg:grid-cols-3 gap-12 mt-8">
        ...
        <div class="similar-games-container mt-8">
            <h2 class="text-blue-500 tracking-wide font-semibold">Similar Games</h2>
